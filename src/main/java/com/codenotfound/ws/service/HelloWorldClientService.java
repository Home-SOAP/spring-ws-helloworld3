...
public class HelloWorldClientService {
  ...
  public String sayHello(String firstName, String lastName) {
    ...
    LOGGER.info("Client '{}' sending person[firstName={},lastName={}]", this, person.getFirstName(), person.getLastName());

    Greeting greeting = (Greeting) webServiceTemplate.marshalSendAndReceive(person);

    LOGGER.info("Client '{}' received greeting='{}'", this, greeting.getGreeting());
